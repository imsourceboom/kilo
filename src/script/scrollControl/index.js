...
(() => {
  ...
  const sceneInfo = [
    ...
    },
    {
      // 1
      type: "normal",
      // heightNum: 5, // type이 normal 인 경우 없어도 됨
      // scrollHeight: 0,
      objs: {
    ...
    },
    {
      ...
      values: {
        messageA_opacity_in: [0, 1, { start: 0.25, end: 0.35 }],
        messageB_opacity_in: [0, 1, { start: 0.55, end: 0.65 }],
        messageC_opacity_in: [0, 1, { start: 0.75, end: 0.85 }],
        messageA_translateY_in: [20, 0, { start: 0.25, end: 0.35 }],
        messageB_translateY_in: [30, 0, { start: 0.55, end: 0.65 }],
        messageC_translateY_in: [30, 0, { start: 0.75, end: 0.85 }],
        messageA_opacity_out: [1, 0, { start: 0.4, end: 0.5 }],
        messageB_opacity_out: [1, 0, { start: 0.68, end: 0.75 }],
        messageC_opacity_out: [1, 0, { start: 0.88, end: 0.95 }],
        messageA_translateY_out: [0, -20, { start: 0.4, end: 0.5 }],
        messageB_translateY_out: [0, -30, { start: 0.68, end: 0.75 }],
        messageC_translateY_out: [0, -30, { start: 0.85, end: 0.95 }],
        pinB_scaleY: [0.5, 1, { start: 0.55, end: 0.65 }],
        pinC_scaleY: [0.5, 1, { start: 0.75, end: 0.85 }],
      },
    },
    {
      // 3
      ...
      objs: {
        ...
        imagePath: [
          "/assets/images/blend/blend-image-1.jpg",
          "/assets/images/blend/blend-image-2.jpg",
        ],
        images: [],
      },
      values: {
    ...
    switch (currentScene) {
      ...
      case 2:
        ...
        if (scrollRatio > 0.9) {
          ...
          objs.context.fillStyle = "rgba(255,255,255,1)";
